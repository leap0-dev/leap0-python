...
class AsyncGitClient:
    ...
    async def _git_result(self, path: str, payload: JsonObject, http_timeout: float | None = None) -> GitResult:
        data = cast(GitResultDict, await self._transport.request_json("POST", path, json=payload, timeout=http_timeout))
    ...
    async def clone(
        ...
        *,
        ...
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/clone", payload, http_timeout=http_timeout)

    @intercept_errors("Failed to get git status: ")
    async def status(self, sandbox: SandboxRef, *, path: str, http_timeout: float | None = None) -> GitResult:
        ...
        Args:
            ...
            http_timeout: Optional HTTP request timeout in seconds for this SDK call.
        """
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/status", {"path": path}, http_timeout=http_timeout)
    ...
    async def branches(
        ...
        *,
        ...
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/branches", payload, http_timeout=http_timeout)

    @intercept_errors("Failed to get unstaged diff: ")
    async def diff_unstaged(self, sandbox: SandboxRef, *, path: str, context_lines: int | None = None, http_timeout: float | None = None) -> GitResult:
        """
    ...
    async def reset(self, sandbox: SandboxRef, *, path: str) -> GitResult:
        ...
        Returns:
            object: Result returned by this operation.
        """
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/reset", {"path": path})
    ...
    async def show(self, sandbox: SandboxRef, *, path: str, revision: str = "HEAD") -> GitResult:
        ...
        Returns:
            object: Result returned by this operation.
        """
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/show", {"path": path, "revision": revision})
    ...
    async def delete_branch(self, sandbox: SandboxRef, *, path: str, name: str, force: bool = False) -> GitResult:
        ...
        Returns:
            object: Result returned by this operation.
        """
        return await self._git_result(f"/v1/sandbox/{sandbox_id_of(sandbox)}/git/delete-branch", {"path": path, "name": name, "force": force})

    @intercept_errors("Failed to stage files: ")
    async def add(self, sandbox: SandboxRef, *, path: str, files: list[str], http_timeout: float | None = None) -> GitResult:
        """
    ...
    async def commit(
        ...
        *,
        ...
        data = cast(GitCommitResponseDict, await self._transport.request_json(
            "POST",
