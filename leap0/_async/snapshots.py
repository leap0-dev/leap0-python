...
class AsyncSnapshotsClient(Generic[AsyncSnapshotSandboxT]):
    ...
    def __init__(self, transport: AsyncTransport, *, sandbox_factory: SandboxFactory[Sandbox, AsyncSnapshotSandboxT] | None = None):
        self._transport = transport
        self._sandbox_factory = sandbox_factory

    def _wrap_sandbox(self, sandbox: Sandbox) -> AsyncSnapshotSandboxT | Sandbox:
    ...
    async def delete(self, snapshot: SnapshotRef, http_timeout: float | None = None) -> None:
        """
                    Delete a snapshot.
        ...
        Args:
            ...
            http_timeout: Optional HTTP request timeout in seconds for this SDK call.
        """
        await self._transport.request("DELETE", f"/v1/snapshot/{snapshot_id_of(snapshot)}", expected_status=204, timeout=http_timeout)
