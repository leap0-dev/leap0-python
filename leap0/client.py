...
class Leap0Client:
    ...
    def __init__(
        ...
        *,
        ...
        self.sandboxes = SandboxesClient(self._transport, sandbox_domain=sandbox_domain)
        ...
        self.code_interpreter = CodeInterpreterClient(self._transport, sandbox_domain=sandbox_domain)
        self.desktop = DesktopClient(self._transport, sandbox_domain=sandbox_domain)
