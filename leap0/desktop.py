...
class DesktopClient:
    ...
    def desktop_url(self, sandbox: SandboxRef) -> str:
        ...
        return f"{_utils.sandbox_base_url(sandbox_id_of(sandbox), self._sandbox_domain)}/"
    ...
    def status_stream(self, sandbox: SandboxRef) -> Iterator[DesktopProcessStatusList]:
        ...
        url = f"{_utils.sandbox_base_url(sandbox_id_of(sandbox), self._sandbox_domain)}/api/status/stream"
